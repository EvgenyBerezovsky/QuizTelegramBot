...
namespace QuizBot_3._0.Infrastructure.XmlDataService
{
    public class XmlDataService : IDataService<Quiz, User>
    {
        //#region Test data
        //Quiz quiz1 = new Quiz()
        //{
        ...
        private void SerializeUsersDataToFile(UserSet us)
        {
            ...
            using (var stream = new FileStream(usersXmlFilePath, FileMode.OpenOrCreate, FileAccess.Write, FileShare.Read))
            {
        ...
        private void SerializeQuizzesDataToFile(QuizSet qs)
        {
            ...
            using (var stream = new FileStream(quizzesXmlFilePath, FileMode.OpenOrCreate, FileAccess.Write, FileShare.Read))
            {
                // Сохраняем объект в XML-файле на диске.
        ...
        private UserSet? DeserializeUsersDataFromFile()
        {
            ...
            using (var stream = new FileStream(usersXmlFilePath, FileMode.Open, FileAccess.Read, FileShare.Read))
            {
        ...
        private QuizSet? DeserializeQuizzesDataFromFile()
        {
            ...
            using (var stream = new FileStream(quizzesXmlFilePath, FileMode.Open, FileAccess.Read, FileShare.Read))
            {
                // Восстанавливаем объект из XML-файла.
